...
//Forms Definition @1-E7A65A4E
public partial class event_viewPage : System.Web.UI.Page
{
//End Forms Definition

//Forms Objects @1-3D11A1B4
    ...
    protected string event_viewContentMeta;
...
//Page_Load Event BeforeIsPostBack @1-65894C7B
...
//Grid Form eventGrid BeforeShow tail @5-A2B17DC5
        eventGridParameters();
        ...
        item.edit_eventHrefParameters.Add("event_id",Request.QueryString,"event_id");
        item.edit_eventHrefParameters.Add("ret_link",System.Web.HttpUtility.UrlEncode(("event_view.aspx?" + System.Web.HttpContext.Current.Request.QueryString.ToString()).ToString()));

        eventGridedit_event.InnerText=Resources.strings.cal_edit_event;
        eventGridedit_event.HRef = item.edit_eventHref+item.edit_eventHrefParameters.ToString("None","", ViewState);
...
//Panel edit Event BeforeShow. Action Custom Code @43-2A29BDB7
	...
	if (!CommonFunctions.EditAllowed(Convert.ToInt32(Request.QueryString["event_id"])))
		...
		eventGridedit_event.HRef = CommonFunctions.CCAddParam(eventGridedit_event.HRef, "ret_link", "event_view.aspx?event_id=" + CommonFunctions.CCGetFromGet("event_id", ""));
    // -------------------------
...
//Label event_location Event BeforeShow. Action Custom Code @208-2A29BDB7
    // -------------------------
...
//Label event_cost Event BeforeShow. Action Custom Code @206-2A29BDB7
    // -------------------------
...
//Link event_url Event BeforeShow. Action Custom Code @207-2A29BDB7
    // -------------------------
...
//OnInit Event @1-E07A32DD
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        event_viewContentMeta = "text/html; charset=" +  ((CCSCultureInfo)System.Threading.Thread.CurrentThread.CurrentCulture).Encoding;
...
//Page event_view Event AfterInitialize. Action Custom Code @179-2A29BDB7
    // -------------------------
			if (!CommonFunctions.ReadAllowed(Convert.ToInt32(CommonFunctions.CCGetFromGet("event_id","0")))) 
				Response.Redirect("index.aspx");
   // -------------------------
//End Page event_view Event AfterInitialize. Action Custom Code
