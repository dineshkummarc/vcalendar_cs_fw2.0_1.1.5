...
public class PageItem
{
    ...
    public static PageItem CreateFromHttpRequest()
    {
        ...
        item.event_name.SetValue(DBUtility.GetInitialValue("event_name"));
        item.close_link.SetValue(DBUtility.GetInitialValue("close_link"));
        item.print_link.SetValue(DBUtility.GetInitialValue("print_link"));
        return item;
    }
    ...
    public FieldBase this[string fieldName]{
        ...
        set{
            switch(fieldName){
                case "event_name":
                    this.event_name = (TextField)value;
                    break;
                case "close_link":
                    this.close_link = (TextField)value;
                    break;
                case "print_link":
                    this.print_link = (TextField)value;
                    break;
                default:
                    throw (new ArgumentOutOfRangeException());
            }
    ...
    public TextField close_link;
    public object close_linkHref;
    public LinkParameterCollection close_linkHrefParameters;
    public TextField print_link;
    public object print_linkHref;
    public LinkParameterCollection print_linkHrefParameters;
    public PageItem()
    {
        event_name=new TextField("", null);
        close_link = new TextField("",null);
        close_linkHrefParameters = new LinkParameterCollection();
        print_link = new TextField("",null);
        print_linkHrefParameters = new LinkParameterCollection();
    }
}
//End Page Data Class
