//DBUtility Class namespaces @1-6703EE74
...
//Check user method @6-2E4D5140
    public static bool CheckUser(string userName,string userPassword)
    {
        DataAccessObject dao=Settings.calendarDataAccessObject;
        string Sql = "SELECT user_id, user_level FROM " + "users"+ " WHERE "+"user_login"+"=" + dao.ToSql(userName,FieldType.Text) + " AND user_password=" + dao.ToSql(userPassword,FieldType.Text);
        ...
        if(ds.Tables[0].Rows.Count>0)
        {
            ...
            HttpContext.Current.Session["GroupID"]= ds.Tables[0].Rows[0]["user_level"].ToString();;
