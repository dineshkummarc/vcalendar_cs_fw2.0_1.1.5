...
//Page_Load Event BeforeIsPostBack @1-1622903B
    PageItem item=PageItem.CreateFromHttpRequest();
    if (!IsPostBack)
    {
            PageDataProvider PageData=new PageDataProvider();
            PageData.FillItem(item);
            html_footer.Text=item.html_footer.GetFormattedValue();
    }
//End Page_Load Event BeforeIsPostBack

//Label html_footer Event BeforeShow. Action Custom Code @3-2A29BDB7
    // -------------------------
	html_footer.Text = CommonFunctions.str_calendar_config("html_footer");
    // -------------------------
//End Label html_footer Event BeforeShow. Action Custom Code
