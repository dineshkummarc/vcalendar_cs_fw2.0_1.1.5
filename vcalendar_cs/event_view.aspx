<!--ASPX page @1-BF9F6A0E-->
<%@ Page language="c#" CodeFile="event_view.aspx.cs" AutoEventWireup="false" Inherits="calendar.event_view.event_viewPage" ResponseEncoding ="utf-8"%>

<%@ Import namespace="calendar.event_view" %>
...
<title><%=Resources.strings.cal_event_view%></title>


<link href="Styles/<%=PageStyleName%>/Style.css" type="text/css" rel="stylesheet"><script language="JavaScript" type="text/javascript">
//Begin CCS script
//End CCS script
</script>
