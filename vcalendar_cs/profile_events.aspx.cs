...
//Forms Definition @1-E75524DA
public partial class profile_eventsPage : System.Web.UI.Page
{
//End Forms Definition

//Forms Objects @1-A37BDBE7
    ...
    protected string events_groupsSearchDatePicker_s_date_fromName;
    protected string events_groupsSearchDatePicker_s_date_fromDateControl;
    protected string events_groupsSearchDatePicker_s_date_toName;
    protected string events_groupsSearchDatePicker_s_date_toDateControl;
    ...
    protected string profile_eventsContentMeta;
...
//Record Form events_groupsSearch BeforeShow tail @9-A2F19998
        ...
        events_groupsSearchs_date_from.Text=item.s_date_from.GetFormattedValue();
        events_groupsSearchDatePicker_s_date_fromName = "events_groupsSearchDatePicker_s_date_from";
        events_groupsSearchDatePicker_s_date_fromDateControl = events_groupsSearchs_date_from.ClientID;
        events_groupsSearchDatePicker_s_date_from.DataBind();
        events_groupsSearchs_date_to.Text=item.s_date_to.GetFormattedValue();
        events_groupsSearchDatePicker_s_date_toName = "events_groupsSearchDatePicker_s_date_to";
        events_groupsSearchDatePicker_s_date_toDateControl = events_groupsSearchs_date_to.ClientID;
        events_groupsSearchDatePicker_s_date_to.DataBind();
//End Record Form events_groupsSearch BeforeShow tail

//ListBox s_category Event BeforeShow. Action Custom Code @69-2A29BDB7
    // -------------------------
...
//Record Form events_groupsSearch LoadItemFromRequest method @9-9E78D020
    protected void events_groupsSearchLoadItemFromRequest(events_groupsSearchItem item, bool EnableValidation)
    {
        ...
        try{
        item.s_date_from.SetValue(events_groupsSearchs_date_from.Text);
        }catch(ArgumentException){
            events_groupsSearchErrors.Add("s_date_from",String.Format(Resources.strings.CCS_IncorrectFormat,"s_date_from",@"ShortDate"));}
        try{
        item.s_date_to.SetValue(events_groupsSearchs_date_to.Text);
        }catch(ArgumentException){
            events_groupsSearchErrors.Add("s_date_to",String.Format(Resources.strings.CCS_IncorrectFormat,"s_date_to",@"ShortDate"));}
        if(EnableValidation)
...
//Record Form events_groupsSearch GetRedirectUrl method @9-E2415DA3
    protected string Getevents_groupsSearchRedirectUrl(string redirectString ,string removeList)
    {
        ...
        if(redirectString == "") redirectString = "profile_events.aspx";
...
//Button Button_DoSearch OnClick. @10-59780A97
        if(((Control)sender).ID == "events_groupsSearchButton_DoSearch")
        {
            RedirectUrl = Getevents_groupsSearchRedirectUrl("", "s_keyword;s_category;s_date_from;s_date_to");
...
//Record Form events_groupsSearch Search Operation tail @9-D336FE33
        if(ErrorFlag)
            events_groupsSearchShowErrors();
        else{
            string Params="";
            ...
            Params+=events_groupsSearchs_date_from.Text!=""?("s_date_from="+Server.UrlEncode(events_groupsSearchs_date_from.Text)+"&"):"";
            Params+=events_groupsSearchs_date_to.Text!=""?("s_date_to="+Server.UrlEncode(events_groupsSearchs_date_to.Text)+"&"):"";
...
//Grid events_groups Bind @5-B6965AFD
...
//Grid Form events_groups BeforeShow tail @5-112DB78C
...
//Label events_groups_TotalRecords Event BeforeShow. Action Retrieve number of records @13-2DD3F696
...
//Grid events_groups Event BeforeShow. Action Custom Code @30-2A29BDB7
    // -------------------------
			if (PagesCount < 2)
...
//Grid events_groups Bind tail @5-FCB6E20C
    }
//End Grid events_groups Bind tail

//Grid events_groups Table Parameters @5-3D13139E
    protected void events_groupsParameters()
    {
        try{
            events_groupsData.Urls_keyword = MemoParameter.GetParam("s_keyword", ParameterSourceType.URL, "", null, false);
            ...
            events_groupsData.SesUserID = IntegerParameter.GetParam("UserID", ParameterSourceType.Session, "", null, false);
            events_groupsData.Urls_date_from = DateParameter.GetParam("s_date_from", ParameterSourceType.URL, Settings.DateFormat, null, false);
            events_groupsData.Urls_date_to = DateParameter.GetParam("s_date_to", ParameterSourceType.URL, Settings.DateFormat, null, false);
        }catch{
...
//Grid events_groups ItemDataBound event @5-4F818799
    protected void events_groupsItemDataBound(Object Sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem) {
            System.Web.UI.HtmlControls.HtmlAnchor events_groupsEditLink = (System.Web.UI.HtmlControls.HtmlAnchor)(e.Item.FindControl("events_groupsEditLink"));
            ...
            DataItem.EditLinkHref = "events.aspx";
            events_groupsEditLink.HRef = DataItem.EditLinkHref + DataItem.EditLinkHrefParameters.ToString("None","", ViewState);
...
//events_groups control Before Show @5-77E330BC
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem) {
//End events_groups control Before Show

//Get Control @71-6DEDB293
            System.Web.UI.HtmlControls.HtmlAnchor events_groupsEditLink = (System.Web.UI.HtmlControls.HtmlAnchor)(e.Item.FindControl("events_groupsEditLink"));
//End Get Control

//Link EditLink Event BeforeShow. Action Custom Code @73-2A29BDB7
    // -------------------------
			events_groupsEditLink.HRef = CommonFunctions.CCAddParam(events_groupsEditLink.HRef, "ret_link", Getevents_groupsSearchRedirectUrl("", ""));
    // -------------------------
//End Link EditLink Event BeforeShow. Action Custom Code

//Get Control @23-43CE4087
            System.Web.UI.HtmlControls.HtmlAnchor events_groupsevent_title = (System.Web.UI.HtmlControls.HtmlAnchor)(e.Item.FindControl("events_groupsevent_title"));
//End Get Control

//Link event_title Event BeforeShow. Action Custom Code @70-2A29BDB7
    // -------------------------
			if (CommonFunctions.str_calendar_config("popup_events") == "1") 
			{
				string parameters = CommonFunctions.CCAddParam(events_groupsevent_title.HRef, "ret_link", Server.UrlEncode(Getevents_groupsSearchRedirectUrl("", "")));
...
//Get Control @74-868E98A5
            System.Web.UI.WebControls.Literal events_groupsevent_time_end = (System.Web.UI.WebControls.Literal)(e.Item.FindControl("events_groupsevent_time_end"));
//End Get Control

//Label event_time_end Event BeforeShow. Action Custom Code @75-2A29BDB7
    // -------------------------
...
//events_groups control Before Show tail @5-FCB6E20C
        }
//End events_groups control Before Show tail

//Grid events_groups ItemDataBound event tail @5-F4064105
...
//Grid events_groups ItemCommand event @5-5088BB1B
...
//OnInit Event @1-9235261D
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        profile_eventsContentMeta = "text/html; charset=" +  ((CCSCultureInfo)System.Threading.Thread.CurrentThread.CurrentCulture).Encoding;
