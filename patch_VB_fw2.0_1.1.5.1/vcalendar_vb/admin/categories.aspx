<!--ASPX page @1-688E3F59-->
    <%@ Page language="vb" CodeFile="categories.aspx.vb" AutoEventWireup="false" Inherits="calendarVB.admin.categories.categoriesPage"  ResponseEncoding ="utf-8"%>
	
	<%@ Import namespace="calendarVB.admin.categories" %>
    <%@ Import namespace="calendarVB.Configuration" %>
    <%@ Import namespace="calendarVB.Data" %>
    
    <%@Register TagPrefix="calendarVB" TagName="header" Src="header.ascx"%>
    <%@Register TagPrefix="CC" Namespace="calendarVB.Controls" %>
...
<calendarVB:header id="header" runat="server"/> 
...
<table cellspacing="0" cellpadding="0" border="0">
 ...
 <CC:SorterItem type="DescOn" runat="server"><img src='<%#"../Styles/" + PageStyleName + "/Images/Desc.gif"%>' border="0"></CC:SorterItem></CC:Sorter></th>
  ...
  <ItemTemplate>
        <tr class="Row">
          <td><a id="categoriescategory_name" href="" runat="server"  ><%#(CType(Container.DataItem,categoriesItem)).category_name.GetFormattedValue()%></a>&nbsp;</td> 
          <td>
...
<CC:Navigator id="NavigatorNavigator" MaxPage="<%# categoriesData.PagesCount%>" PageNumber="<%# categoriesData.PageNumber%>" runat="server">
 ...
 <CC:NavigatorItem type="PrevOff" runat="server"><img src='<%#"../Styles/" + PageStyleName + "/Images/PrevOff.gif"%>' border="0"></CC:NavigatorItem>&nbsp;<%# (CType(Container,Navigator)).PageNumber.ToString() %>
            <%#Resources.strings.CCS_Of%>&nbsp;<%# (CType(Container,Navigator)).MaxPage.ToString() %>&nbsp; <CC:NavigatorItem type="NextOn" runat="server"><asp:LinkButton id="NavigatorNext" runat="server"><img src='<%#"../Styles/" + PageStyleName + "/Images/Next.gif"%>' border="0"></asp:LinkButton> </CC:NavigatorItem>
